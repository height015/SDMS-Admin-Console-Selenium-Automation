...
public class AuthAuthorizationObj
{
    private readonly IWebDriver _webDriver;
    public AuthAuthorizationObj(IWebDriver webDriver)
    {
    ...
    public IWebElement tblResult => _webDriver.FindElement(By.CssSelector("table.table-hover"));
